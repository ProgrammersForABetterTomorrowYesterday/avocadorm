...
class Resource {
  ...
  Iterable<Property> get simpleProperties => this.properties.where((f) => f is! PrimaryKeyProperty && f is! ForeignKeyProperty);

  /// The primary key property and normal properties contained in the [Entity].
  Iterable<Property> get simpleAndPrimaryKeyProperties => this.properties.where((f) => f is! ForeignKeyProperty);

  /// The foreign key properties contained in the [Entity].
  Iterable<Property> get foreignKeyProperties => this.properties.where((f) => f is ForeignKeyProperty);
  ...
  static Property _convertManyToOneForeignKeyColumnToProperty(String name, Type type, Column column, Iterable<VariableMirror> variableMirrors) {
  ...
  static Property _convertOneToManyForeignKeyColumnToProperty(String name, Type type, Column column, Iterable<VariableMirror> variableMirrors) {
